...
3. Verifica la presenza di un **Dell PERC H730** (o controller RAID equivalente) collegato alla backplane dei dischi, necessario per la gestione dei dischi posteriori.[web:41][web:45][web:46]
...
2. Premi **Enter** e segui la procedura guidata di installazione per scegliere il disco di sistema e confermare l'installazione.
